...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        public MainV2()
        {
            ...
            {
                changelanguage(CultureInfoEx.GetCultureInfo("id-ID"));
            }
        ...
        {
            var sr = new StreamReader("password.json");
            var reader = new JsonTextReader(sr);

            var serializer = new JsonSerializer();
            var passwords = serializer.Deserialize<List<string>>(reader);

            return passwords.Any(p => p == inputPassword);
        }
        bool IsPasswordConnectValid(string inputPassword)
        {
            var sr = new StreamReader("password_connect.json");
            var reader = new JsonTextReader(sr);
        ...
        public void MenuSetup_Click(object sender, EventArgs e)
        {
            ...
            var pw = "";
            if (InputBox.Show("Password", "Ketikkan password Anda", ref pw, true) ==
        ...
        private void MenuConnect_Click(object sender, EventArgs e)
        {
            ...
            var pw = "";
            if (InputBox.Show("Password", "Ketikkan password connect Anda", ref pw, true) ==
                System.Windows.Forms.DialogResult.OK)
            {
                if (IsPasswordConnectValid(pw))
                {
                    Connect();
        ...
        public void changelanguage(CultureInfo ci)
        {
            ...
            //MessageBox.Show("change lang to " + ci.ToString() + " current " + Thread.CurrentThread.CurrentUICulture.ToString());
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://bengkeldronejogja.com");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url https://bengkeldronejogja.com");
            }
        }
